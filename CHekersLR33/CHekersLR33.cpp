...
// CHekersLR33.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCHekersLR33App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CCHekersLR33App

CCHekersLR33App::CCHekersLR33App()
{
...
// Единственный объект CCHekersLR33App

CCHekersLR33App theApp;


// Инициализация CCHekersLR33App

BOOL CCHekersLR33App::InitInstance()
{
